...
export default function ExplainProduct2() {
  ...
  let FilterProduct = products.find((product) => {
    return product.id == "6408d0c56406cd15828e8ee0";
  });
      ...
      {loading ? (
        ...
        <div className="col-12 bigdivexplainproduct">
          ...
          <div className="col-11 col-sm-10 col-md-7 col-lg-6 col-xl-7 seconddivdescriptionexplainproduct">
            ...
            <p className="col-xl-11 pExplain">
              {FilterProduct?.description?.split(" ")?.splice(0, 51)?.join(" ")}
            </p>
            <button
              onClick={() => {
                navigate(`/singleproduct/6408d0c56406cd15828e8ee0`);
              }}
